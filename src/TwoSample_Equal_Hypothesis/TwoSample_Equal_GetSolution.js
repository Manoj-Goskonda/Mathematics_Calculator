...
const TwoSample_Equal_GetSolution = (props) => {
        ...
        <div className="col-lg-12 col-12 ">
          <div className="row ">
            <div className="col-lg-8 col-8 mar text align-self-center">
              <p className="get-text">Enter summarized data below</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="row justify-content-center">
                ...
                <div className="col-lg-6 col-6 mar">
                  <input
                    ...
                    className="inputfield"
                    placeholder="578"
                    value={numMeanDifference}
                    onChange={inputMeanDifference}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="row  justify-content-center">
                ...
                <div className="col-lg-6 col-6 mar">
                  <input
                    ...
                    className="inputfield"
                    placeholder="10"
                    value={numMeanSampleSize}
                    onChange={inputMeanSampleSize}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="row  justify-content-center">
                ...
                <div className="col-lg-6 col-6 mar">
                  <input
                    ...
                    className="inputfield"
                    placeholder="12.72"
                    value={numMeanSampleSize1}
                    onChange={inputMeanSampleSize1}
                  />
                </div>
              </div>
            </div>
        ...
        <div className="input container">
          <div className="row justify-content-center">
            <div className="col-lg-12 col-12 ">
              ...
              <p style={{ fontSize: "18px" }}>Total Obeservations 4</p>
              <br></br>
...
export default TwoSample_Equal_GetSolution;
