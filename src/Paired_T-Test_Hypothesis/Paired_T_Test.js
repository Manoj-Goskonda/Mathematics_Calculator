...
import Paired_T_Test_GetSolution from './Paired_T_Test_GetSolution';
import Paired_T_Test_Solution from './Paired_T_Test_Solution';
import Paired_T_Test_Theory from './Paired_T_Test_Theory';
                ...
                <div classNameName="col-lg-12 col-12 multitabs">
                    ...
                    <div className="tab-content">
                        <div className={`tab-pane ${showcode == false ? "active" : " "}`} id="tabs-41" role="tabpanel">
                            <Paired_T_Test_GetSolution sendtoparent={sendtoparent} getSolutionData={getSolutionData} />
                        </div>
                        {showcode == true ? <div className={`tab-pane ${showcode == true ? "active" : " "}`} id="tabs-42" role="tabpanel">
                            <Paired_T_Test_Solution getSolutionDataObject={getSolutionDataObject} />
                        </div> : null}
                        <div className="tab-pane" id="tabs-43" role="tabpanel">
                            <Paired_T_Test_Theory />
                        </div>
                    </div>
                </div>
            </div>
