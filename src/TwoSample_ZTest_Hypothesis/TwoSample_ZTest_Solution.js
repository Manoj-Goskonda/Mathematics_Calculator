...
import Twosampleztest1 from '../assets/Images/Twosampleztest1.png';
import Twosampleztest2 from '../assets/Images/Twosampleztest2.png';
import Hypothesis3 from '../assets/Images/Hypothesis3.png';

const TwoSample_ZTest_Solution = (props) => {
                    ...
                    <div className="col-lg-12 col-12 box">
                        <div className="input container">
                            <div className="row justify-content-center">
                                ...
                                <h2 className="get-text">Two Sample Z test :</h2>
                                    ...
                                    <div className="soln-box">
                                        ...
                                        <div class="row2">
                                        <p>Sample Standard deviation (σ1)    =     </p>
                                            <p>{props.getSolutionDataObject.numSampleSD}</p>
                                            <p>Sample Standard deviation (σ2)    =   </p>
                                    ...
                                    <p>This is a two tailed test, for two population means with two independent samples, known population Standard deviation.</p>
                                    <h3>• Test Statistic :</h3>
                                    <p>The z-statistic is computed as follows :</p>
                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                        <img className="theory-graph-img" src={Twosampleztest1} />  
                                    </div>
                                    <h3>• Critical Value :</h3>
                                    <p>Here, Confidence level = 0.95, α = 0.05  </p>
                                    <p>From z -table, critical value of two tailed test is zc = 1.991</p>
                                    <h3> • P - Value :</h3>
                                    ...
                                    <div className='pl-5 pb-3'>
                                        <ul>
                                            {/* <li><p>5% Rejection region of z-statistic is R : [ z : z < -1.96 / z > 1.96 ].If test statistic falls in this region then we reject Ho.</p></li> */}
                                            <br></br>
                                        </ul>
                                    </div>
                                    ...
                                    <h3>• Decision :</h3>
                                    <p>Since, it is observed that, test statistic = -13.856 falls in rejection region, | z | {">"} zc = 1.96, we reject the null hypothesis.</p>
                                    <br></br>
                                    {/* <p>Using p-value,   p-value = 0 < 0.05, If is concluded that nullhypothesis is rejected. </p>  */}
                                    <h3>• Conclusion :</h3>
                            ...
                            <div className="input container">
                                <div className="row justify-content-center">
                                    <div className="col-lg-12 col-12 ">
                                        ...
                                        <div className="col-lg-12 col-12">
                                            <div className="row">
                                                <div className="col-lg-12 col-12 row align-items-baseline">
                                                    ...
                                                    <h5 className=" ml-lg-2">x1, x2 - Sample average of group1 and group2</h5>
                                                </div>
                                                <div className="col-lg-12 col-12 row align-items-baseline">
                                                ...
                                                <div className="col-lg-12 col-12 row align-items-baseline">
                                                    <h5 className="required">σ</h5>
                                                    <h5 className=" ml-lg-2">σ1,σ2 - Populayion SD of group1 and group2</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <img className="theory-graph-img" src={Twosampleztest2} /> 
                                        </div>
                                        <p><span style={{ color: "#EA4335" }}>Critical Value</span> with n - 1 degrees of freedom & pre-selected level of
                                        significance (α).</p><br></br>
...
export default TwoSample_ZTest_Solution;
