            ...
            <div className="col-lg-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item home_breadcumb">
                    <a href="#"></a>Binomial Distribution Calculator
                  </li>
                </ol>
              </nav>
              ...
              <h1 className="" style={{fontWeight:'bold'}}>Binomial Distribution Calculator</h1> 
                {/* <svg
                  width="30"
                  height="30"
                  viewBox="0 0 39 36"
