...
import img2 from "../assets/Images/image100.png";
import img3 from "../assets/Images/image101.png";
import img4 from "../assets/Images/image102.png";

const Binomial_Solution = (props) => {
  
  /* ------------ = Equal ----------- */
  const [Success, setSuccess] = useState(0); // jStat -> Number of Success of x or k , Number of Trails, Probability

  useEffect(() => {
    let result = jStat.binomial.pdf(
  ...
  /* ------------ Less ----------- */
  const [Success1, setSuccess1] = useState(0); // jStat -> Number of Success of x or k , Number of Trails, Probability

  useEffect(() => {
    let result1 = jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
      ) - Success;
  ...
  useEffect(() => {
    let result2 = jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
    ); 
  ...
  useEffect(() => {
    let result3 = jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
    ) - Success;
  ...
  useEffect(() => {
    let result4 = jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
    ) - Success - Success2;
  ...
  useEffect(() => {
    let result5 = 1 - jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
      );
  ...
  useEffect(() => {
    let result6 =Success + 1 - jStat.binomial.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
      );
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <div className="soln-box">
                    <div className="row1">
                      <p>Population Probability of Success (p) = </p>
                      <p>{props.getSolutionDataObject.numProbability}</p>
                    </div>
                    <div className="row2">
                      <p>Number of events (n) = </p>
                  ...
                  <p>Binomial Probability Distribution Formula :</p>
                  <div
                  ...
                  <p>The binomial coefficient,(X^n) is defined by</p>
                  <div
                    className="btformula mt-3 mb-3 "
                    style={{ textAlign: "center" }}
                  >
...
export default Binomial_Solution;
