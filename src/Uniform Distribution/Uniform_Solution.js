...
import Uniform1 from "../assets/Images/Uniform1.png";
import Uniform2 from "../assets/Images/Uniform2.png";

const Uniform_Solution = (props) => {
  /* ---------------- Equal  -------------- */
  const [Success, setSuccess] = useState(0);

  useEffect(() => {
    let result = jStat.uniform.cdf(
  ...
  useEffect(() => {
    let result1 = 1 - jStat.uniform.cdf(
      props.getSolutionDataObject.numEqual,
      props.getSolutionDataObject.numTrails,
      props.getSolutionDataObject.numProbability
    );
            ...
            <div className="input container">
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <p>
                    The above information about the uniform distribution and the
                    event for which the probability needs to be computed:
                  </p>
                  <div
                  ...
                  <p>
                    Therefore, based on the information provided, it is
                    concluded that Pr(X≤3)={Success}, {Success1}
                  </p>
                </div>
                <br></br>
                <br></br>
...
export default Uniform_Solution;
