...
import Weibull2 from '../assets/Images/Weibull2.png';

const Weibull_Solution = (props) => {
...
/* ---------------- Greater Than   -------------- */
    ...
    useEffect(() => {
    let result5 = 1 - jStat.weibull.cdf(
    parseFloat(props.getSolutionDataObject.numEqual),
    parseFloat(props.getSolutionDataObject.numTrails),
    parseFloat(props.getSolutionDataObject.numProbability)
    );
...
/* ---------------- Greater Than Equal   -------------- */
    ...
    useEffect(() => {
    let result6 = 1 - jStat.weibull.cdf(
    parseFloat(props.getSolutionDataObject.numEqual),
    parseFloat(props.getSolutionDataObject.numTrails),
    parseFloat(props.getSolutionDataObject.numProbability)
    );
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    ...
                                    <div className="soln-box">
                                        <div class="row1">
                                            <p>Scale parameter (λ) = </p>
                                            <p>{props.getSolutionDataObject.numTrails}</p>
                                        </div>
                                        <div class="row2">
                                            <p>Shape parameter (k) = </p>
                                    ...
                                    <p>Weibull Probability Distribution Formula :</p>
                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                        <img src={Weibull1} />
                                    </div>
                                    <p>This implies that,</p>
                                    <p>K={props.getSolutionDataObject.numProbability}, λ={props.getSolutionDataObject.numTrails}, x={props.getSolutionDataObject.numEqual}</p>
                                   <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                    </div>
                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                        <img src={Weibull2} />
...
export default Weibull_Solution;
