...
const Z_Score_GetSolution = (props) =>{
...
//    };
   ...
   const solutionButtonClick = () => {
    ...
    //  let numDofValue1 = numDof1 ? numDof1 : numSample1;
     props.getSolutionData(tailed, numDof, numDof1, numSign, DecimalValues);
                        ...
                        <div className="input container">
                                    ...
                                    <div className="row  justify-content-center">
                                        ...
                                        <div className='ol-lg-6 col-6 mar'>
                                            <select className="inputfield" id="test" name="testlist" value={tailed} onChange={handleChange}>
                                                ...
                                                <option className="inputfield" value="Left-Tailed">Left-Tailed P value</option>
                                                <option clacssName="inputfield" value="Right-Tailed">Right-Tailed P value</option>
                                                <option clacssName="inputfield" value="Two-Tailed">Two-Tailed P value</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    <div className="row  justify-content-center">
                                        <div className='col-lg-6 col-6 mar text align-self-center'>
                                        <p style={{fontSize:'24px'}}>Numerator degrees of freedom (d₁) :</p>
                                        </div>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    <div className="row  justify-content-center">
                                        <div className='col-lg-6 col-6 mar text align-self-center'>
                                        <p style={{fontSize:'24px'}}>Denominator degrees of freedom (d₂) :</p>
                                        </div>
                                        <div className='col-lg-6 col-6 mar'>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    <div className="row  justify-content-center">
                                        <div className='col-lg-6 col-6 mar text align-self-center'>
                                        <p style={{fontSize:'24px'}}>Your F-score (test Statistic) :</p>
                                        </div>
                                        <div className='col-lg-6 col-6 mar'>
...
export default Z_Score_GetSolution;