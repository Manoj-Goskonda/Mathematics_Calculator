...
const [critical, setCritical] = useState(0);
  ...
  useEffect(() => {
    let result = jStat.centralF.cdf(parseFloat( 
...
useEffect(() => {
  let result1 = 1 - jStat.centralF.cdf(parseFloat( 
      props.getSolutionDataObject.numSign),
      parseFloat(props.getSolutionDataObject.numDof),
      parseFloat(props.getSolutionDataObject.numDof1)
  );
...
/* -------------------------  Two Side ------------------*/  
  ...
  useEffect(() => {
  let result2 = 2 * (jStat.centralF.cdf(parseFloat( 
      props.getSolutionDataObject.numSign),
      parseFloat(props.getSolutionDataObject.numDof),
      parseFloat(props.getSolutionDataObject.numDof1))
  );
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <div className="soln-box">
                    ...
                    <div class="row1">
                      <p>Test Statistics(F) = </p>
                      <p>{props.getSolutionDataObject.numSign}</p>
                    </div>
                  </div>
                  <div className="soln-box">
                    <p>
                      Here, the test statistic (F) is {props.getSolutionDataObject.numSign} with degrees of
                      freedom {props.getSolutionDataObject.numDof} having {props.getSolutionDataObject.tailed} F-distribution. Then the P
                      value is :
                    </p>
                  ...
                  <h5 className="critical-heading">
                    The F critical value for right-tailed test using Excel :
                  </h5>
                  ...
                  <div className="sigsolution">
                    <p className="mt-2">
                      = F.DIST.RT (test static, degree_freedom1,
                      degree_freedom2)
                    </p>
                    <p className="mt-2">= F.DIST.RT ({props.getSolutionDataObject.numSign}, {props.getSolutionDataObject.numDof}, {props.getSolutionDataObject.numDof1})</p>
...
export default Z_Score_Solution;
