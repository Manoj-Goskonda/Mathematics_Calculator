...
const T_Score_Solution = (props) => {

/* -------------- Left Tailed -------------- */  
  const [critical, setCritical] = useState(0);

  useEffect(() => {
    let result = jStat.studentt.cdf(parseFloat(
  ...
  useEffect(() => {
    let result1 = 1 - jStat.studentt.cdf(parseFloat(
      props.getSolutionDataObject.numSign),
      parseFloat(props.getSolutionDataObject.numDof)
    );
  ...
  useEffect(() => {
    let result2 = 2 - 2 * jStat.studentt.cdf(parseFloat(
      props.getSolutionDataObject.numSign),
      parseFloat(props.getSolutionDataObject.numDof)
    );
            ...
            <div className="input container">
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <div className="soln-box">
                    <p>
                      Here, the test statistic (t) is {props.getSolutionDataObject.numSign} with degrees of
                      freedom {props.getSolutionDataObject.numDof} having {props.getSolutionDataObject.tailed} t-distribution. Then the P
                      value is :
                    </p>
                  ...
                  <div className="sigsolution">
                    <p className="mt-2">
                      = T.DIST.RT (Test Statistics, deg_freedom)
                    </p>
                    <p className="mt-2">= T.DIST.RT ({props.getSolutionDataObject.numSign}, {props.getSolutionDataObject.numDof})</p>
...
export default T_Score_Solution;
