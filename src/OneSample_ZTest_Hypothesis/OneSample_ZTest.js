...
import Onesample_ZTest_GetSolution from './OneSample_ZTest_GetSolution';
import Onesample_ZTest_Solution from './OneSample_ZTest_Solution';
import Onesample_ZTest_Theory from './OneSample_ZTest_Theory';


const  Onesample_Ztest = () =>{
                ...
                <div classNameName="col-lg-12 col-12 multitabs">
                    ...
                    <div className="tab-content">
                        <div className={`tab-pane ${showcode == false ? "active" : " "}`} id="tabs-41" role="tabpanel">
                            < Onesample_ZTest_GetSolution sendtoparent={sendtoparent} getSolutionData={getSolutionData} />
                        </div>
                        {showcode == true ? <div className={`tab-pane ${showcode == true ? "active" : " "}`} id="tabs-42" role="tabpanel">
                            < Onesample_ZTest_Solution getSolutionDataObject={getSolutionDataObject} />
                        </div> : null}
                        <div className="tab-pane" id="tabs-43" role="tabpanel">
                            < Onesample_ZTest_Theory />
                        </div>
                    </div>
                </div>
            </div>
...
export default Onesample_Ztest;