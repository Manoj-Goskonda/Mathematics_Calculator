...
import Gamma_GetSolution from './Gamma_GetSolution';
import Gamma_Solution from './Gamma_Solution';
import Gamma_Theory from './Gamma_Theory';
                                ...
                                <div className="col-lg-12 col-12 multitabs">
                                    ...
                                    <div className="tab-content ">
                                        <div className={`tab-pane ${showcode == false ? "active" : " "}`} id="tabs-2" role="tabpanel">
                                            <Gamma_GetSolution sendtoparent={sendtochild} getSolutionData={getSolutionData} />
                                        </div>
                                        {showcode == true ? <div className={`tab-pane ${showcode == true ? "active" : " "}`} id="tabs-3" role="tabpanel">
                                            <Gamma_Solution getSolutionDataObject={getSolutionDataObject} />
                                        </div> : null}
