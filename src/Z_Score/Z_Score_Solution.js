...
/* ------------- Left Tailed --------------- */  
  ...
  useEffect(() => {
    let result = jStat.normal.cdf( 
    props.getSolutionDataObject.numSign,0,1
...
/* ------------- Right Tailed --------------- */ 
  ...
  useEffect(() => {
    let result1 = jStat.normal.cdf(1 -
    props.getSolutionDataObject.numSign,1,1
...
/* ------------- Two Tailed --------------- */ 
  ...
  useEffect(() => {
    let result2 = 2 - 2 * jStat.normal.cdf( 
      props.getSolutionDataObject.numSign,0,1
    );
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <div className="soln-box">
                    ...
                    <div class="row1">
                      <p>Test Statistics(z) = </p>
                      <p>{props.getSolutionDataObject.numSign}</p>
                    </div>
                  </div>
                  <div className="soln-box">
                    <p>
                    Here, the test statistic (z) is {props.getSolutionDataObject.numSign} having {props.getSolutionDataObject.tailed}
                    z standard normal distribution. Then the P value is :
                    </p>
                  ...
                  <h5 className="critical-heading">
                    The P value for Right-tailed test using Excel :
                  </h5>
                  <div className="sigsoln">
                    <div className="significance">
                      <li>Test Statistics (z) : </li>
                      <p> {props.getSolutionDataObject.numSign}</p>
                    </div>
                  </div>
                  <div className="sigsolution">
                    <p className="mt-2">
                      = 1 - NORM.S.DIST (Test Statistics, True)
                    </p>
                    <p className="mt-2">= 1 - NORM.S.DIST ({props.getSolutionDataObject.numSign}, True)</p>
                    <p className="mt-2">= {critical} , {critical1} and {critical2}  </p>
                  </div>
                  <div class="sol-para">
                    <p>
                    Here, the test statistic (z) is {props.getSolutionDataObject.numSign} having {props.getSolutionDataObject.tailed} 
                    z standard normal distribution. Then the P value is {critical}
                    </p>
                  </div>
                </div>
              </div>
