...
export const Hypergeometric_Disc = () => {
  return (
    <>
      {/* <Distribution /> */}
            ...
            <div className="col-lg-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item home_breadcumb">
                    <a href="#"></a>Hypergeometric Distribution Calculator
                  </li>
                </ol>
              </nav>
              ...
              function that gives the probabilities of occurrence of different possible outcomes for 
              an experiment. It is a mathematical description of a random phenomenon in terms of its 
              sample space and the probabilities of events.
              </p>
              <br></br>
              <div className="col-lg-12 subcalheading d-flex">
              <h1 className="" style={{fontWeight:'bold'}}>Hypergeometric Distribution Calculator</h1> 
                {/* <svg
                  width="30"
                  height="30"
                  viewBox="0 0 39 36"
...
export default Hypergeometric_Disc;
