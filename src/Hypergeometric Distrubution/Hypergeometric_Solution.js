...
import Hypergeometric2 from '../assets/Images/Hypergeometric2.png';


const Hypergeometric_Solution = (props) => {

/* ------------ = Equal ----------- */
  const [Success, setSuccess] = useState(0);   // jStat -> Number of Success of x , Number of Trails, Probability of k , Sample value of n

  useEffect(() => {
    let result = jStat.hypgeom.pdf( 
        props.getSolutionDataObject.numEqual,
        props.getSolutionDataObject.numTrails,
        props.getSolutionDataObject.numProbability,
        props.getSolutionDataObject.numSample
    );
...
/* ------------ Less ----------- */
    const [Success1, setSuccess1] = useState(0); // jStat -> Number of Success of x , Number of Trails, Probability of k , Sample value of n

    useEffect(() => {
      let result1 = jStat.hypgeom.pdf( 
        props.getSolutionDataObject.numEqual,
        props.getSolutionDataObject.numTrails,
        props.getSolutionDataObject.numProbability,
        props.getSolutionDataObject.numSample
...
/* ---------------- Greater Than   -------------- */
    ...
    useEffect(() => {
    let result5 = 1 - jStat.hypgeom.cdf(
        props.getSolutionDataObject.numEqual,
        props.getSolutionDataObject.numTrails,
        props.getSolutionDataObject.numProbability,
        props.getSolutionDataObject.numSample
...
/* ---------------- Greater Than Equal   -------------- */
    ...
    useEffect(() => {
    let result6 = Success +1 -jStat.hypgeom.cdf(
        props.getSolutionDataObject.numEqual,
        props.getSolutionDataObject.numTrails,
        props.getSolutionDataObject.numProbability,
        props.getSolutionDataObject.numSample
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    ...
                                    <div className="soln-box">
                                        <div class="row1">
                                            <p>Total number of Object (N) = </p>
                                            <p>{props.getSolutionDataObject.numTrails}</p>
                                        </div>
                                        <div class="row2">
                                            <p>Total number of defeactives (K) = </p>
                                            <p>{props.getSolutionDataObject.numProbability}</p>
                                        </div>
                                        <div class="row1">
                                            <p>Sample size (n)=</p>
                                            <p>{props.getSolutionDataObject.numSample}</p>
                                        </div>
                                    ...
                                    <p>Hypergeometric Probability Distribution Formula :</p>
                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                        <img src={Hypergeometric1} />
                                    </div>
                                    <p>This implies that,</p>
                                    <p> N={props.getSolutionDataObject.numTrails}, K={props.getSolutionDataObject.numProbability}, n={props.getSolutionDataObject.numSample},X={props.getSolutionDataObject.numEqual}</p>

                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>

                                    </div>
                                    <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                        <img src={Hypergeometric2} />
                                    </div>
...
export default Hypergeometric_Solution;
