...
import TwoSample_Unequal_GetSolution from './TwoSample_Unequal_GetSolution';
import TwoSample_Unequal_Solution from './TwoSample_Unequal_Solution';
import TwoSample_Unequal_Theory from './TwoSample_Unequal_Theory';


const TwoSample_Unequal = () =>{
                ...
                <div classNameName="col-lg-12 col-12 multitabs">
                    ...
                    <div className="tab-content">
                        <div className={`tab-pane ${showcode == false ? "active" : " "}`} id="tabs-41" role="tabpanel">
                            <TwoSample_Unequal_GetSolution sendtoparent={sendtoparent} getSolutionData={getSolutionData} />
                        </div>
                        {showcode == true ? <div className={`tab-pane ${showcode == true ? "active" : " "}`} id="tabs-42" role="tabpanel">
                            <TwoSample_Unequal_Solution getSolutionDataObject={getSolutionDataObject} />
                        </div> : null}
                        <div className="tab-pane" id="tabs-43" role="tabpanel">
                            <TwoSample_Unequal_Theory />
                        </div>
                    </div>
                </div>
            </div>
...
export default TwoSample_Unequal;