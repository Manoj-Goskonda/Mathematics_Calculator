...
import Onesamplepraportion1 from '../assets/Images/Onesamplepraportion1.png';
import Onesamplepraportion2 from '../assets/Images/Onesamplepraportion2.png';
import Hypothesis3 from '../assets/Images/Hypothesis3.png';

const OneSample_ZTest_Praportion_Solution = (props) => {
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-12 col-12 ">
                                ...
                                <div className="soln-box">
                                    ...
                                    <div class="row1">
                                        <p>Favourable cases (X) = </p>
                                        <p>{props.getSolutionDataObject.numSampleAvg}</p>
                                    </div>
                                    <div class="row2">
                                        <p>Sample Proportion (p̂) = </p>
                                ...
                                <p>This is a two tailed test, for one population proportion.</p>
                                <h3>• Test Statistic :</h3>
                                <p>The z-statistic is computed as follows :</p>
                                <div className='btformula mt-3 mb-3 ' style={{ textAlign: 'center' }}>
                                <img className="theory-graph-img" src={Onesamplepraportion1} />
                                </div>
                        ...
                        <div className="input container">
                            <div className="row justify-content-center">
                                <div className="col-lg-12 col-12 ">
                                    ...
                                    <div className="col-lg-12 col-12">
                                        <div className="row">
                                            <div className="col-lg-12 col-12 row align-items-baseline">
                                                ...
                                                <h5 className=" ml-lg-2">p the sample Proportion.</h5>
                                            </div>
                                            <div className="col-lg-12 col-12 row align-items-baseline">
                                                <h5 className="required">x</h5>
                                                <h5 className=" ml-lg-2">x the number of successes (if needed).</h5>
                                            </div>
                                            <div className="col-lg-12 col-12 row align-items-baseline">
                                                <h5 className="required">n</h5>
                                                <h5 className=" ml-lg-2">n - Sample size</h5>
                                            </div> 
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                     <img className="theory-graph-img" src={Onesamplepraportion2} /> 
                                    </div>
...
export default OneSample_ZTest_Praportion_Solution;
