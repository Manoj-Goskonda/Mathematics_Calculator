...
const Standard_Solution = (props) => {
  /* --------------  Left Side -------------------*/
  const [critical, setCritical] = useState(0);

  useEffect(() => {
    let result = jStat.normal.inv(props.getSolutionDataObject.numSign, 0, 1);
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <h5 className="critical-heading">
                    The z critical value for Right-tailed test using Excel :
                  </h5>
                  ...
                  <div className="sigsolution">
                    <p className="mt-2">= NORM.S.INV (1 - α) </p>
                    <p className="mt-2">= NORM.S.INV (1 - 0.05)</p>
                    <p className="mt-2">
                      {" "}
                      = {critical} and {critical1} and {critical3}, {critical2}
                    </p>
                  </div>
                  <div class="sol-para">
                    <p>
...
export default Standard_Solution;
