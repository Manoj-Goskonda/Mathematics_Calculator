...
import Lognormal_GetSolution from './Lognormal_GetSolution';
import Lognormal_Solution from './Lognormal_Solution';
import Lognormal_Theory from './Lognormal_Theory';
                                ...
                                <div className="col-lg-12 col-12 multitabs">
                                    ...
                                    <div className="tab-content ">
                                        <div className={`tab-pane ${showcode == false ? "active" : " "}`} id="tabs-2" role="tabpanel">
                                            <Lognormal_GetSolution sendtoparent={sendtochild} getSolutionData={getSolutionData} />
                                        </div>
                                        {showcode == true ? <div className={`tab-pane ${showcode == true ? "active" : " "}`} id="tabs-3" role="tabpanel">
                                            <Lognormal_Solution getSolutionDataObject={getSolutionDataObject} />
                                        </div> : null}
