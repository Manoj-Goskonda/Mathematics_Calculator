...
const Lognormal_Solution = (props) => {
  ...
  useEffect(() => {
    let result1 = jStat.lognormal.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
    );
  ...
  useEffect(() => {
    let result2 = jStat.lognormal.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
    );
  ...
  /* ------------ Less Than and less than ----------- */
      ...
      useEffect(() => {
      let result3 = jStat.lognormal.cdf(
        parseFloat(props.getSolutionDataObject.numEqual),
        parseFloat(props.getSolutionDataObject.numTrails),
        parseFloat(props.getSolutionDataObject.numProbability)
      ) - Success;
  ...
  useEffect(() => {
    let result4 = jStat.lognormal.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
      ) - Success - Success2;
  ...
  useEffect(() => {
    let result5 = 1 - jStat.lognormal.cdf(
      parseFloat(props.getSolutionDataObject.numEqual),
      parseFloat(props.getSolutionDataObject.numTrails),
      parseFloat(props.getSolutionDataObject.numProbability)
      );
            ...
            <div className="input container">
              <div className="row justify-content-center">
                <div className="col-lg-12 col-12 ">
                  ...
                  <p>Lognormal Probability Distribution Formula :</p>
                  <div
                  ...
                  <p>
                    {" "}
                    µ={props.getSolutionDataObject.numTrails}, σ=
                    {props.getSolutionDataObject.numProbability}, x=
                    {props.getSolutionDataObject.numEqual}
                  </p>
                  <p>P(X≤3)= ?</p>

                  <p>First we convert Lognormal to normal Distribution</p>
                  <br></br>
                  <p> Taking Natural Logarithm</p>
                  <br></br>
                  <p>
                    P(Logx ≤ Log3) ….. so we get normal distribution then we
                    convert it into Standard Normal Variate(SNV) i.e. z
                  </p>
                  <br></br>
                  <p>Z = x- µ/ σ = log3-50/6 = -8.1150</p>
                  <br></br>
                  <p>P(Z ≤ -8.1150) = 0</p>
...
export default Lognormal_Solution;
